...
<body>
<h1 align="center">Insert DataCustomer's Cars</h1>
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">ID Cars:</td>
      <td><input type="text" name="idcar" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">ID Customers:</td>
      <td><input type="text" name="idcus" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Number Cars:</td>
      <td><input type="text" name="numcar" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Category Cars:</td>
      <td><input type="text" name="cag" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Brand Cars:</td>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Number Machine:</td>
      <td><input type="text" name="nummec" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Number Gas:</td>
...
<p>&nbsp;</p><br /><br /><tr>
  <td align="right" width="20%"><a href="datacar.php">Back To Data Customer's Car</a></td></tr>
</body>
</html>