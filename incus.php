...
<body>
<h1 align="center">Insert Data Customers</h1>
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Number Card:</td>
      <td><input type="text" name="numcard" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tellophone:</td>
...
<p>&nbsp;</p><br /><br />
<tr>
  <td align="right" width="20%"><a href="customer.php">Back To Data Cutomers</a></td></tr>
</body>
</html>